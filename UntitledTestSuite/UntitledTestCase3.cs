...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase3
    {
        ...
        public void TheUntitledTestCase3Test()
        {
            ...
            driver.FindElement(By.Id("FirstName")).SendKeys("asdasd");
            driver.FindElement(By.Id("LastName")).Clear();
            driver.FindElement(By.Id("LastName")).SendKeys("asdasd");
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("asdasdasd@gmail.com");
            ...
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("asdasdasd2313245@gmail.com");
            driver.FindElement(By.Id("register-button")).Click();
